...
injectRef.regeneratorRuntime = __webpack_require__(30);
injectRef.fetch = _system2.default;
injectRef.prompt = _system4.default;
injectRef._ = _helper2.default;

exports.default = {
  showMenu: _util2.default.showMenu,
  createShortcut: _util2.default.createShortcut
};
(exports.default || module.exports).manifest = {"package":"com.application.demo","name":"cnode-quickapp","versionName":"1.0.0","versionCode":"1","minPlatformVersion":"1020","icon":"/common/img/logo.png","features":[{"name":"system.prompt"},{"name":"system.router"},{"name":"system.shortcut"},{"name":"system.fetch"}],"permissions":[{"origin":"*"}],"config":{"logLevel":"debug"},"router":{"entry":"index","pages":{"index":{"component":"index"}}},"display":{"titleBarBackgroundColor":"#f2f2f2","titleBarTextColor":"#414141","menu":true,"pages":{"index":{"titleBarText":"cnode-quickapp","menu":false}}}};
}
...
function formatTime(date) {
  ...
  return [year, month, day].map(leftPad).join('-') + ' ' + [hour, minute, second].map(leftPad).join(':');
}
...
_.formatDate = function formatDate(date) {
  var human = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
